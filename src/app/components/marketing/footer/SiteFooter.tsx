      ...
      <div className="container mx-auto px-4 pt-12 md:pt-20 pb-8 md:pb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-6 md:gap-8 mb-8 md:mb-10">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col items-center text-center md:items-start md:text-left">
            <img src={logo} alt="statTarian Logo" className="h-8 w-auto mb-0" />
            <h3
          ...
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/features" className="text-xs md:text-sm text-muted-foreground hover:text-accent transition-colors">
                  Features
                </Link>
              </li>
              <li>
                <Link to="/pricing" className="text-xs md:text-sm text-muted-foreground hover:text-accent transition-colors">
                  Pricing
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="text-xs md:text-sm text-muted-foreground hover:text-accent transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-xs md:text-sm text-muted-foreground hover:text-accent transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/legal/privacy" className="text-xs md:text-sm text-muted-foreground hover:text-accent transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/legal/terms" className="text-xs md:text-sm text-muted-foreground hover:text-accent transition-colors">
                  Terms of Service
                </Link>
              </li>
            </ul>
